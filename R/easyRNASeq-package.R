...
##' Type: \tab Package\cr
##' Version: \tab 1.3.13\cr
##' Date: \tab 2012-08-25\cr
...
##' feature of interest, for as many samples as provided and will return a count matrix (N*M) where
##' N will be the features and M the samples. This data can be corrected to \pkg{RPKM} in which case
##' a matrix of corrected value is returned instead, with the same dimensions. If the necessary sample
